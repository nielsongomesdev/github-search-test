            ...
            <Flex direction="column" gap={6}>
              <Flex direction="column" gap={6} bg="white" p={6} borderRadius="4px" boxShadow="sm" border="1px solid" borderColor="gray.200">
                <Flex gap={4} alignItems="center">
                  <Image src={user.avatar_url} alt={user.name || user.login} borderRadius="full" boxSize="48px" objectFit="cover" border="1px solid" borderColor="border.gray" />
                  <Box>
                ...
                {user.bio && <Text color="gray.600" fontSize="sm">{user.bio}</Text>}
                ...
                <VStack align="start" spacing={3} color="gray.600" fontSize="sm" w="100%">
